...
public class ItemControlFan extends ItemControl{
    ...
    private ItemControlFan(Context context,String name,int isEnable){
    ...
    public ItemControlFan(String name,int isEnable){
        this(null,name,isEnable);
    }

    public ItemControlFan(Context context,int sensorId,String deviceId,String name,int isEnable){
